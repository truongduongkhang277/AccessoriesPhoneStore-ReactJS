      ...
      <div className="category">
        ...
        <div className="small-container">
            ...
            <div className="row">
                ...
                {/* <div className="col-4">
                    <img src="./images/product-2.jpg" alt="product 2 image"></img>
                ...
                <div className="col-4">
                    <img src="./images/product-3.jpg" alt="product 3 image"></img>
                    <h4>Red Printed T-Shirt</h4>
                    <div className="rating">
                        <i className="fa fa-star" aria-hidden="true"></i>
                        <i className="fa fa-star" aria-hidden="true"></i>
                ...
                <div className="col-4">
                    <img src="./images/product-4.jpg" alt="product 4 image"></img>
                    <h4>Red Printed T-Shirt</h4>
                    <div className="rating">
                        <i className="fa fa-star" aria-hidden="true"></i>
                        <i className="fa fa-star" aria-hidden="true"></i>
            ...
            {/* <div className="row">
                <div className="col-4">
                    <img src="./images/product-5.jpg" alt="product 5 image"></img>
                    <h4>Red Printed T-Shirt</h4>
                    <div className="rating">
                        <i className="fa fa-star" aria-hidden="true"></i>
                        <i className="fa fa-star" aria-hidden="true"></i>
                ...
                <div className="col-4">
                    <img src="./images/product-6.jpg" alt="product 6 image"></img>
                    <h4>Red Printed T-Shirt</h4>
                    <div className="rating">
                        <i className="fa fa-star" aria-hidden="true"></i>
                        <i className="fa fa-star" aria-hidden="true"></i>
                ...
                <div className="col-4">
                    <img src="./images/product-7.jpg" alt="product 7 image"></img>
                    <h4>Red Printed T-Shirt</h4>
                    <div className="rating">
                        <i className="fa fa-star" aria-hidden="true"></i>
                        <i className="fa fa-star" aria-hidden="true"></i>
                ...
                <div className="col-4">
                    <img src="./images/product-8.jpg" alt="product 8 image"></img>
                    <h4>Red Printed T-Shirt</h4>
                    <div className="rating">
                        <i className="fa fa-star" aria-hidden="true"></i>
                        <i className="fa fa-star" aria-hidden="true"></i>
